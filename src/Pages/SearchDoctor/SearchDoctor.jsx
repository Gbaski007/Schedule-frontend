          ...
          <div className="search-doctor">
            ...
            <div className="sidebar d-md-block d-none">
              ...
              <div className="p-4">
                ...
                <div className="checkbox-group mt-4">
                  <h3 className="mb-3">Select Field</h3>
                  <label>
                    <input
                      type="checkbox"
                      name="hair treatment"
                      checked={field === "hair treatment"}
                      ...
                      {doctors?.doctors?.map((doctor) => (
                        ...
                        >
                          ...
                          <div className="">
                            ...
                            <div className="d-flex flex-column butt">
