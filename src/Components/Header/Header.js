...
const Header = () => {
  ...
  const sections = [
    { id: "home", label: "Home", to: "/", dropdown: null },
    {
      ...
      label: "Therapists",
      dropdown: [
        { label: "Therapist Profile", to: "/doctor" },
        { label: "Profile Setting", to: "/doc-profile-settings" },
        { label: "Appointments", to: "/appointments" },
        { label: "Therapist Login", to: "/loginn" },
      ],
    },
    {
      id: "Patients",
          ...
          <nav className="d-flex justify-content-between align-items-center py-3">
            <div className="nav-bar">
              <Link to={"/"} className="logo-img d-flex align-items-center">
                <img
                  className="img-fluid logo-imgv"
                  src="https://pathivu.dreamstechnologies.com/template/assets/img/home5/logo.png"
                />
              </Link>
